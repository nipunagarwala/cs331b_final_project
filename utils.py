...
def quantizeParseArgs():
	...
	# parser.add_argument('--quant_method', type = str, default='linear', help='linear|minmax|log|tanh')
	...
	parser.add_argument('--phase', choices = ['quantize', 'tune', 'act_quantize'], type = str,
